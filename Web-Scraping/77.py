...
# Access the OIG URL
driver.get("https://mdbnc.health.maryland.gov/psychverification/default.aspx")
...
last_name_input = driver.find_element(By.ID, "bodyContentPlaceHolder_lastNameSearch")
last_name_input.send_keys(last_name)


# Locate and click the search button
search_button = driver.find_element(By.ID, "bodyContentPlaceHolder_search1")
search_button.click()
...
old_file_name = "Maryland Board of Examiners of Psychologists_ License Verification.pdf"
