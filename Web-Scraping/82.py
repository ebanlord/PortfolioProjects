# -*- coding: utf-8 -*-
"""
Created on Fri Jun  9 14:14:59 2023
...
# Access the OIG URL
driver.get("https://www.pfr.maine.gov/almsonline/almsquery/SearchCompany.aspx")
...
profession_type_dropdown=Select(driver.find_element(By.ID, "scRegulator"))
profession_type_dropdown.select_by_index(1)

time.sleep(1)
# Find the last name input element and send the user input
last_name_input = driver.find_element(By.ID, "scCompanyName")
...
time.sleep(1)
records_per_page=Select(driver.find_element(By.ID, "ddlPageSize"))
records_per_page.select_by_index(4)
refresh_page = driver.find_element(By.ID, "btnPageSize")
refresh_page.click()
...
old_file_name = "ALMS License Information _ Search Result.pdf"

# Specify the new file name
new_file_name = f"{last_name}_.pdf"
